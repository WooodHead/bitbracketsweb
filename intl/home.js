export default {
  en: {
    ...
    'home.section4.title4':
      'fee of the pool for helping to spread crypto awareness',
  ...
  es: {
    ...
    'home.section3.title3':
      'Crea un nombre a la quiniela y determina el monto para ingresar a jugar. Si no tienes una billetera de criptomonedas, aprende aquí.',
    'home.section3.title4':
      'Cuantos más participantes, más grande es el premio. Todo el monto de la quiniela estará asegurado por Contratos Inteligentes.',
    'home.section3.title5': ' Ingresar predicciones',
    'home.section3.title6':
      ' ¿Ganará Costa Rica contra Brasil? Tus predicciones se guardarán en el Blockchain. Debes ingresar tus predicciones antes de que comience la copa.',
    'home.section3.title7': 'Vas ganando esta quiniela?',
    'home.section3.title8':
      'Si estás ganando, y no hay posibilidad de que alguien te pueda ganar, publica tu resultado al blockchain! El contrato inteligente validará tu puntaje y se es el mayor pasaras a ser el posible ganador, si nadie mas publica un puntaje mayor el premio sera tuyo. Cuantos más participantes, mayor será el premio. Todo el monto de la quiniela estará asegurado por Contratos Inteligentes.',
    'home.section3.title9':
      'Finge hasta que ... ¡alguien pueda decir lo contrario!',
    'home.section3.title10':
      'Al finalizar el torneo existe un periodo de espera para publicar puntajes. Si termina ese periodo y tu tienes el puntaje mayor publicado, ¡entonces tu eres el ganador! El contrato inteligente te permitirá tomar todo el premio.',
