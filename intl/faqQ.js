export default {
  ...
  es: [
    ...
    {
      question:
        '¿Qué necesito para crear mi pozo de premios y empezar a jugar con mis amigos?',
      answerbullet: [
        {
          bulletfirst:
    ...
    {
      question:
        '¿Pueden varios jugadores ganar el pozo de premios, se permiten los empates?',
      answer:
    ...
    {
      question:
        '¿Qué pasa si no se lanza antes de que comience la Copa del Mundo?',
      answer:
    ...
    {
      question:
        '¿Cómo hace BitBrackets para ganar dinero con los pozos de premios?',
      answer:
    ...
    {
      question:
        '¿Cuándo es el ICO? ¿Dónde está tu token? ¿Cómo puedo comprar los tokens?',
      answer:
