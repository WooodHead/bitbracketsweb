...
const messages = defineMessages({
  ...
  backButton: {
    ...
    defaultMessage: 'Back',
    description:
      'Create Pool Page -> Create Pool Form -> Back Step Button Label'
  },
  nextButton: {
    id: 'nextButton',
    defaultMessage: 'Next',
    description:
      'Create Pool Page -> Create Pool Form -> Next Step Button Label'
  },
  finishButton: {
    id: 'finishButton',
    defaultMessage: 'Finish',
    description:
      'Create Pool Page -> Create Pool Form -> Finish Steps Button Label'
  }
});
...
class CreatePoolForm extends Component {
  ...
  componentWillMount() {
    this.props.dispatch(
      actions.change('createPool.entryFee', web3.utils.fromWei(FEE, 'ether'))
    );
  }
...
export default withStyles(styles)(
  injectIntl(connect(mapStateToProps)(CreatePoolForm))
);
