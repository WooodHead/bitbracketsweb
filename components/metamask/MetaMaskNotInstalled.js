...
const messages = defineMessages({
  ...
  installDescription2: {
    ...
    defaultMessage:
      'Then Create an account. You are given a seed phrase that can be used to restore all the accounts you ever create withing Metamask.',
    description: ''
  },
  etherHeader: {
    id: 'etherHeader',
  ...
  sendDescription2: {
    id: 'sendDescription2',
    defaultMessage:
      'If you want to try with Play money follow the instructions here to load play money into your wallet:',
    description: ''
  },
  headingTertiary2: {
    id: 'headingTertiary2',
        ...
        <div className={classes.expansionPanel}>
          <ExpansionPanel>
            <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
              <Typography>
                {intl.formatMessage(messages.installHeader)}
              </Typography>
            </ExpansionPanelSummary>
            <ExpansionPanelDetails>
              <ol style={{ textAlign: 'left' }}>
                <li>
                  ...
                  >
                    <Typography>
                      {intl.formatMessage(messages.installDescription1)}
                    </Typography>
                  </a>
                </li>

                <img
                  src="./../../static/metamaskpic.png"
                  alt="metamask"
                  height="150"
                  width="150"
                />
                <li>
                  <Typography>
                    {intl.formatMessage(messages.installDescription2)}
                  </Typography>
                </li>
              </ol>
            </ExpansionPanelDetails>
          ...
          <ExpansionPanel>
            ...
            <ExpansionPanelDetails>
              <ol style={{ textAlign: 'left' }}>
                ...
                <li>
                  <Typography>
                    {intl.formatMessage(messages.etherDescription1)}
                  </Typography>
                </li>
                <li>
                  <Typography>
                    {intl.formatMessage(messages.etherDescription2)}
                  </Typography>
                  <a
